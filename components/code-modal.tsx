...
const CodeModal: React.FC<CodeModalProps> = ({
  ...
  return (
    ...
    >
      <div className="xs:w-[480px] w-4/5 h-3/6 p-2 bg-white dark:bg-[rgba(30,30,30,1.5)] rounded-lg shadow-xl flex flex-col justify-center items-center gap-y-8 fixed">
